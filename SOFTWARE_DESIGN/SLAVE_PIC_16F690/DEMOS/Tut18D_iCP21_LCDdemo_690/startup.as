	...
	; Compiler options:
	;
	; -oTut18D_iCP21_LCDdemo_690.cof -mTut18D_iCP21_LCDdemo_690.map \
	; --summary=default --output=default main.p1 --chip=16F690 -P \
	; --runtime=default --opt=default,+asm,-debug,-speed,+space,9 --warn=0 \
	; -D__DEBUG=1 --rom=default --ram=default --addrqual=ignore -g \
